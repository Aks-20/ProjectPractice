...
import ContentLoader from "../Components/PageLoader/PageLoader.jsx"; // Ensure this path is correct
import CoinInfo from "../Components/Coininfo/CoinInfo.jsx"; // Corrected import path
import useFetchCoin from "../Hooks/useFetchcoin.js"; // Corrected import path
...
function CoinDetailsPage() {
    ...
    if (isLoading) {
        return <ContentLoader />; // Use ContentLoader for loading state
    }
